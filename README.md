...
local objects = {}
local themes = {
Background = Color3.fromRGB(9, 0, 19),
Glow = Color3.fromRGB(10, 0, 248),
Accent = Color3.fromRGB(21, 0, 255),
LightContrast = Color3.fromRGB(0, 0, 1),
DarkContrast = Color3.fromRGB(31, 31, 31),
TextColor = Color3.fromRGB(223, 0, 255)
}
do
